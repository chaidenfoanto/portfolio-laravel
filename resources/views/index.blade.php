    ...
    <main role="main">
        ...
        <section class="about">
            <div class="about__wrapper wrapper--small">
                ...
                <img class="about__visual" style="height: 570px;width:auto" src="{{ mix('img/about-visual.png') }}" alt="Chaiden Foanto">
            </div>
        </section>
        <!-- END SECTION: About -->
                ...
                <ul class="work__list">
                    <li class="work__list-el work__list-el--is-active">
                        ...
                        <div class="work__visual">
                            <img src="{{ mix('img/CF-Company.png') }}" alt="CF Holding Company">
                        </div>
                    </li>
                    <li class="work__list-el">
                        ...
                        <div class="work__visual">
                            <img src="{{ mix('img/NPLC.png') }}" alt="NPLC Mockup UI">
                        </div>
                    </li>
                    <li class="work__list-el">
                        <div class="work__content">
                        ...
                        <div class="work__visual">
                            <img src="{{ mix('img/CF-Univ.png') }}" alt="CF University Form Web Design">
                        </div>
                    </li>
                </ul>
        ...
        <section id="contact" class="contact">
            ...
            <div class="contact__wrapper wrapper--large">
                <div class="contact__visual">
                    <img src="{{ secure_mix('img/contact-visual.png') }}" alt="Chaiden Foanto's location">
                </div>
